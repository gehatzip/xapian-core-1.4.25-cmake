...
class AndContext : public Context {
	...
	PostList * postlist(PostList * pl, const vector<PostList*>& andpls) const;
    };
...
PostList *
AndContext::PosFilter::postlist(PostList * pl, const vector<PostList*>& andpls) const
try {
    vector<PostList *>::const_iterator terms_begin = andpls.begin() + begin;
    vector<PostList *>::const_iterator terms_end = andpls.begin() + end;
